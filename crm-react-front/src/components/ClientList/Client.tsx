...
export const Client = (): JSX.Element => {
  return (
    <div className={styles.oneClientList}>
      ...
      <h3>630098</h3>
      <h3>6300$</h3>
      <input name="managers" className={styles.statusInput} autoComplete="off" list="managers" />
      ...
      <h3>06.08.23</h3>
      <input name="status" className={styles.statusInput} autoComplete="off" list="status" />
      <datalist id="status">
