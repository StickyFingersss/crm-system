...
const Layout = (): JSX.Element => {
  ...
  return (
    <div className={styles.wrapper}>
      <Button onClick={openLogModal} className={styles.btnLog}>
        Sign in
      </Button>
      <Button onClick={openRegModal} className={styles.btnReg}>
        Sign up
      </Button>
      ...
      {/* Модалка логина */}
      <Modal finalFocusRef={finalRef} isOpen={isLogModalOpen} onClose={closeLogModal}>
        <ModalOverlay backdropFilter="auto" backdropInvert="80%" />
        <ModalContent background="#bebebe" className={styles.modal}>
          ...
          <ModalBody pb={6}>
            <form onSubmit={submitHandlerLog}>
              ...
              <Button type="submit" colorScheme="green" margin="2" fontSize="2xl" color="black">
                Sign in
              </Button>
              <Box mt={4}>
                {successMessage && (
